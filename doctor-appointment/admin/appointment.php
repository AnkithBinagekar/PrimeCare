        ...
        <form method="post" id="edit_appointment_form">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default"><a href="https://primecarevc.000webhostapp.com/" target="_blank">Open Video Consultation</a></button>
                    <button type="button" class="btn btn-default"><a href="http://localhost/contact_us/index.php" target="_blank">Send Link To Patient</button>
